...
<div class="col-lg-14 mt-4">
    <div class="card">
        <h5 class="card-header bg-dark text-light">Pelanggan</h5>
        <div class="card-body bg-secondary">
            <div class="row">
                <div class="column d-flex justify-content-start">
                    <button class="btn btn-dark text-light mb-2" data-bs-toggle="modal" data-bs-target="#tambahpelanggan"> Tambah
                        Pelanggan</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="Rega" name="id" required value="<?php echo rand(1000, 9999) ?>">
                            ...
                            <form class="text-center needs-validation" novalidate action="proses/edit-pelanggan.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="Rega" name="id_pelanggan" required value="<?php echo $row['id_pelanggan'] ?>">
                                            <label for="floatingInput">Id Pelanggan</label>
                                            <div class="invalid-feedback text-start">
                                                Masukan Id Pelanggan
                                            </div>
