...
<div class="col-lg-14 mt-2">
    <div class="card">
        <h5 class="card-header bg-dark text-light">Penjualan</h5>
        <div class="card-body bg-secondary">
            <div class="row">
                <div class="column d-flex justify-content-start">
                    <button class="btn btn-dark text-light" data-bs-toggle="modal" data-bs-target="#tambahpelanggan"> Tambah
                        Penjualan</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="Rega" name="id_penjualan" required
