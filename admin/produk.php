...
<div class="col-lg-14 mt-4">
    <div class="card">
        <h5 class="card-header bg-dark text-light">Produk</h5>
        <div class="card-body bg-secondary">
            <div class="row">
                <div class="column d-flex justify-content-end">
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambahpelanggan"> Tambah
                        Produk</button>
                </div>
            </div>
            <!-- modal tambah -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput"
                                                placeholder="Rega" name="id_produk" required
